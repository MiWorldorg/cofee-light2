                ...
                <table class="w-full table-fixed mb-6">
                    ...
                    <tr class="bg-grey-600 ">
                        <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase text-center font-peyda">
                            ایدی</th>
                        <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase  text-center ">     نام مشتری   </th>
                        <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase  text-center ">  مقذار هزینه   </th>
                        <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase  text-center">   امتیاز وفاداری
                        </th>
                    ...
                    @foreach ($customers as $customer)
                        <tr>
                            ...
                            <td class="py-4 px-6 border-b border-amber-200 truncate text-center">{{ $customer->user->name }}
                            </td>
                            <td class="py-4 px-6 border-b border-amber-200 text-center">{{ $customer->total_spent }}</td>
                            <td class="py-4 px-6 border-b border-amber-200 text-center">{{ $customer->loyaly_points }}</td>
