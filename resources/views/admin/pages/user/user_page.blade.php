                    ...
                    <tbody class="bg-white">
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="py-4 px-6 border-b border-gray-200 truncate text-center">{{ $user->name }}</td>
                                <td class="py-4 px-6 border-b border-gray-200 text-center">{{ $user->phone_number }}</td>
