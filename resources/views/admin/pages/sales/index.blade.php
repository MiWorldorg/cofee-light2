                    ...
                    <thead>
                        <tr class="bg-grey-600 ">
                            <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase text-center font-peyda">
                                ایدی</th>
                            <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase  text-center "> کد محصول
                            </th>
                            <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase  text-center "> تعداد
                            </th>
                            <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase  text-center"> تاریخ فروش
                            </th>
                    ...
                    <tbody class="bg-slate-700 text-amber-200">
                        @foreach ($sales as $sale)
                            <tr>
                                ...
                                <td class="py-4 px-6 border-b border-amber-200 text-center">{{ jdate($sale->sale_date) }}
                                </td>
